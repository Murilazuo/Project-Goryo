...
if gunName != "" {
	draw_sprite(spr_gunIcon,idSprite,x,y-30);
	...
	draw_sprite(spr_iconGunStats,3,x+sprPosition,y+20+yPosition);
	draw_text_transformed(x+textPosition,y+22+yPosition,string_format(cooldown,3,1),textScale,textScale,0);
	
	sprPosition += 30;
	textPosition += 30;
	
	draw_sprite(spr_iconGunStats,4,x+sprPosition,y+20+yPosition);
	draw_text_transformed(x+textPosition,y+22+yPosition,string_format(precision,3,1),textScale,textScale,0);
